...
<body class="container py-4">
  ...
  <form method="post" action="/store" id="productForm" class="mb-4">
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <select name="type" id="typeSelect" class="form-select">
        ...
        <option value="physical" <?= (isset($old['type']) && $old['type'] === 'physical') ? 'selected' : '' ?>>Physical</option>
        <option value="digital" <?= (isset($old['type']) && $old['type'] === 'digital') ? 'selected' : '' ?>>Digital</option>
      </select>
    </div>
    ...
    <div id="digitalFields" style="display:none;">
      ...
      <div class="mb-3">
        ...
        <input name="download_url" class="form-control" value="<?= htmlspecialchars($old['download_url'] ?? '') ?>">
      </div>
    </div>
